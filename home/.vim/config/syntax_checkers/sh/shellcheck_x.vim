"============================================================================
"File:        shellcheck_x.vim
"Description: Shell script syntax/style checking plugin for syntastic
"============================================================================

if exists('g:loaded_syntastic_sh_shellcheck_x_checker')
    finish
endif
let g:loaded_syntastic_sh_shellcheck_x_checker = 1

let s:save_cpo = &cpo
set cpo&vim

function! SyntaxCheckers_sh_shellcheck_x_GetLocList() dict " {{{1
    let buf = bufnr('')
